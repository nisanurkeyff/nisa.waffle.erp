...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed layout-compact" dir="ltr" data-theme="theme-default" data-assets-path="/assets/" data-template="vertical-menu-template" data-style="light">
    <head>
        ...
        <title> <?=$row_site->TITLE?> | Kampanya Ekle </title>
        <?=$cTheme->Linkler()?>
    </head>
    <body>
                                        ...
                                        <div class="card-header overflow-hidden">
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li class="nav-item" role="presentation">
                                                    <button class="nav-link waves-effect active" data-bs-toggle="tab" data-bs-target="#tab_kampaya" role="tab" aria-selected="true">
                                                    <span class="ri-user-line ri-20px d-sm-none"></span><span class="d-none d-sm-block">Kampanya Bilgisi</span></button>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="tab-content">
                                            <div class="tab-pane fade active show" id="tab_kampaya" role="tabpanel">
                                                <form id="kampanyaEkle" enctype="multipart/form-data">
                                                    <div class="row g-6">
                                                        <div class="col-md-6">
                                                            <div class="input-group input-group-merge">
                                                                <span class="input-group-text"><i class="ri-user-add-line"></i></span>
                                                                <div class="form-floating form-floating-outline">
                                                                    <input type="text" id="kampanya" name="kampanya" class="form-control" value="<?=$_REQUEST['kampanya']?>" onchange="this.value=this.value.turkishToUpper();" placeholder="Kampanya">
                                                        ...
                                                        <div class="col-md-3 col-6">
                                                            <div class="form-floating form-floating-outline">
                                                                <input type="text" id="bas_tarih" name="bas_tarih" class="form-control datepicker active" placeholder="YYYY-MM-DD" readonly="readonly">
                                                                <label>Başlangıç Tarih</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 col-6">
                                                            <div class="form-floating form-floating-outline">
                                                                <input type="text" id="bas_saat" name="bas_saat" class="form-control time-mask" placeholder="20:00" autocomplete="off">
                                                                <label>Başlangıç Saat</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 col-6">
                                                            <div class="form-floating form-floating-outline">
                                                                <input type="text" id="bit_tarih" name="bit_tarih" class="form-control datepicker active" placeholder="YYYY-MM-DD" readonly="readonly">
                                                                <label>Bitiş Tarih</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 col-6">
                                                            <div class="form-floating form-floating-outline">
                                                                <input type="text" id="bit_saat" name="bit_saat" placeholder="20:00" class="form-control time-mask" autocomplete="off">
...
<script type="text/javascript">
    ...
    $("#kampanyaEkle").on("submit", function(event) {
        event.preventDefault();
        var formData = new FormData(this);

        formData.append("controller", "kampanya");
        formData.append("action", "kampanya_ekle");
