...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed layout-compact" dir="ltr" data-theme="theme-default" data-assets-path="/assets/" data-template="vertical-menu-template" data-style="light">
    <head>
        ...
        <title> <?=$row_site->TITLE?> | Şube Ekle </title>
        <?=$cTheme->Linkler()?>
    </head>
    <body>
                                                    ...
                                                    <div class="row g-6">
                                                        <div class="col-md-12">
                                                            <div class="input-group input-group-merge">
                                                                ...
                                                                <div class="form-floating form-floating-outline">
                                                                    <input type="text" id="sube" name="sube" class="form-control" value="<?=$_REQUEST['sube']?>" onchange="this.value=this.value.turkishToUpper();" placeholder="Şube">
                                                                    <label>Şube</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-floating form-floating-outline">
                                                                <select name="satis_turu_id" id="satis_turu_id" class="select2 form-select" data-style="btn-default">
                                                                    <?=$cSube->SatisTürleri()->setSeciniz()->setSecilen($_REQUEST['satis_turu_id'])->getSelect("ID", "AD")?>
                                                                </select>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="input-group input-group-merge">
                                                                ...
                                                                <div class="form-floating form-floating-outline">
                                                                    <input type="text" id="url" name="url" class="form-control" value="<?=$_REQUEST['url']?>" onchange="this.value=this.value.turkishToLower();" placeholder="Menü URL">
...
<script type="text/javascript">
    ...
    $("#subeEkle").on("submit", function(event) {
        event.preventDefault();
        showSpinner();
        $.ajax({
            url: "/router.php",
            type: "POST",
            data: $(this).serialize() + "&controller=sube&action=sube_ekle",
            dataType: "json",
