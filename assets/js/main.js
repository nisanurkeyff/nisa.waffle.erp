...
if (typeof $ !== 'undefined') {
  $(function () {
    ...
    if (searchInput.length) {
      ...
      var searchJson = 'arama_json.php'; // For vertical layout
        ...
        searchInput
          .typeahead(
            ...
            // Pages
            {
              ...
              templates: {
                header: '<h6 class="suggestions-header text-primary mb-0 mx-3 mt-3 pb-2">Sayfalar</h6>',
                ...
                notFound:
                  ...
                  '<p class="py-2 mb-0"><i class="ri-warning-line me-2 ri-14px"></i> Sonuç Bulunamadı</p>' +
                  '</div>'
              }
            },
            // Files
            /*
            {
              ...
              templates: {
                header: '<h6 class="suggestions-header text-primary mb-0 mx-3 mt-3 pb-2">Dosyalar</h6>',
