...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed layout-compact" dir="ltr" data-theme="theme-default" data-assets-path="/assets/" data-template="vertical-menu-template" data-style="light">
    <head>
        ...
        <title> <?=$row_site->TITLE?> | Yorum Ekle </title>
        <?=$cTheme->Linkler()?>
    </head>
    <body>
                                            ...
                                            <div class="tab-pane fade active show" id="tab_yorum" role="tabpanel">
                                                <form id="yorumEkle">
                                                    <div class="row g-6">
                                                        <div class="col-md-6">
                                                            <div class="input-group input-group-merge">
                                                                ...
                                                                <div class="form-floating form-floating-outline">
                                                                    <input type="text" id="isim" name="isim" class="form-control" value="" placeholder="İsim">
                                                                    <label>İsim</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-floating form-floating-outline">
                                                                <input type="text" id="tarih" name="tarih" class="form-control datepicker active" value="<?=date('Y-m-d')?>" placeholder="YYYY-MM-DD" readonly="readonly">
                                                                <label>Tarih</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="input-group input-group-merge">
                                                                ...
                                                                <div class="form-floating form-floating-outline">
                                                                    <textarea class="form-control" id="yorum" name="yorum" placeholder="Yorum" style="height: 120px;"></textarea>
...
<script type="text/javascript">
    ...
    $("#yorumEkle").on("submit", function(event) {
        ...
        $.ajax({
            url: "/router.php",
            type: "POST",
            data: $(this).serialize() + "&controller=yorum&action=yorum_ekle",
            dataType: "json",
